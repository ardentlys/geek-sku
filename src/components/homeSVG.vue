    ...
    <div class="homeSVG">
        <div class="jumbotron">
            ...
            >
                <div
                    ...
                    "
                    :style="{
                        transform: `rotateX(${parallaxCheapXD}deg)
                                rotateY(${parallaxCheapYD}deg)`,
                    }"
                >
                    <svg
                        class="screen-svg"
                        ...
                        style="
                            ...
                            width: 80%;
                            height: 80%;
                            left: calc(50% - 307.06px);
                            transition: all 0.3s ease-out 0s;
                        "
                        :style="{
                            transform: `translateX(${
                                parallaxCheapX * 0.3 + 0
                            }px)
                                    translateY(${
                                        parallaxCheapY * 0.5 + 53.6677
                                    }px)`,
                        }"
                    >
                        <path
                        ...
                        ></path>
                        <path
                            d="M987.7 678.14V364.023"
                            stroke="var(--screen-c-0)"
                            stroke-width="35"
                            stroke-linecap="round"
                            data-v-f4464888=""
                        ></path>
                        <path
                            d="M850.7 678.14V414.023"
                            stroke="var(--screen-c-0)"
                            stroke-width="35"
                            stroke-linecap="round"
                            data-v-f4464888=""
                        ...
                        ></path>
                        <path
                            d="M586.413 680.14V514.023"
                            stroke="var(--screen-c-0)"
                            stroke-width="35"
                            stroke-linecap="round"
                        ></path>
                        <path
                            d="M454.268 680.14V564.023"
                            stroke="var(--screen-c-0)"
                            stroke-width="35"
                            stroke-linecap="round"
                        ></path>
                    ...
                    <svg
                        class="people-svg cursor-pointer"
                        width="344"
                        height="290"
                        viewBox="0 0 344 290"
                        fill="none"
                        ...
                        :style="{
                            transform: `translateX(${
                                parallaxCheapX + 52.4095
                            }px)
                                    translateY(${
                                        parallaxCheapY + 40.6677
                                    }px) scale(1)`,
                        }"
                    >
                        <g
                            clip-path="url(#clip0_11237_126775)"
                            data-v-006549dc=""
                        >
                            <path
                        ...
                        <defs data-v-006549dc="">
                            <clipPath
                                id="clip0_11237_126775"
                                data-v-006549dc=""
                            >
                                <rect
                                    width="343"
                    ...
                    <svg
                        ...
                        :style="{
                            transform: `translateX(${
                                parallaxCheapX + 250.317
                            }px)
                                    translateY(${parallaxCheapY + 255.401}px)`,
                        }"
                    >
                        <g
                            clip-path="url(#clip0_11237_126796)"
                            data-v-289a1ee8=""
                        >
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M5.66289 1.92664C3.21061 1.92664 1.22266 3.9146 1.22266 6.36687V155.114C1.22266 157.567 3.21061 159.555 5.66289 159.555H173.559L186.602 172.32L199.09 159.555H256.536C258.988 159.555 260.976 157.567 260.976 155.114V6.36688C260.976 3.9146 258.988 1.92664 256.536 1.92664H52.66289Z"
                                fill="#5c80ff"
                                data-v-289a1ee8=""
                            ></path>
                            <path
                    ...
                    <svg
                        ...
                        :style="{
                            transform: `translateX(${
                                parallaxCheapX + -16.7085
                            }px)
                                    translateY(${parallaxCheapY + 11.003}px)`,
                        }"
                    >
                        <g
                            filter="url(#filter0_dd_11237_126801)"
                            data-v-30184cf1=""
                        >
                            <path
                    ...
                    <!-- <svg
                            ...
                            style="
                                ...
                                top: 0px;
                                right: 0px;
                                transform: translateX(-0.590452px)
                                    translateY(9.1692px);
                            "
                        >
                            <path
        ...
        <div class="svgCover">
            ...
            <img
                ...
                class="svgCover"
                src="@/assets/homeSVGW.png"
            />
            <!-- 暗夜模式 -->
            <img v-else class="svgCover" src="@/assets/homeSVGB.png" />
        </div>
    </div>
</template>
...
// 时差偏移角度
let parallaxCheapXD = ref(0);
let parallaxCheapYD = ref(0);
// 时差xy偏移
let parallaxCheapX = ref(0);
let parallaxCheapY = ref(0);

// 屏幕可视区域高度
let clientHeight = computed(() => document.documentElement.clientHeight);
// 屏幕可视区域宽度
let clientWidth = computed(() => document.documentElement.clientWidth);
...
let homeMouseMove = (e) => {
    ...
    // 角度比例
    let YdegProportion = 0.0015;
    let XdegProportion = 0.0001;
    // 偏移比例
    let xyProportion = 0.008;

    // 鼠标在左边
    if (screenX < clientWidth.value / 2) {
        parallaxCheapYD.value = -(screenX * YdegProportion);
        parallaxCheapX.value = -(screenX * xyProportion);
    } else {
        // 鼠标在右边
        parallaxCheapYD.value = screenX * YdegProportion;
        parallaxCheapX.value = screenX * xyProportion;
    ...
    // 鼠标在上边
    if (screenY < clientHeight.value / 2) {
        parallaxCheapXD.value = -(screenY * XdegProportion);
        parallaxCheapY.value = screenY * xyProportion;
    } else {
        // 鼠标在下边
        parallaxCheapXD.value = screenY * XdegProportion;
        parallaxCheapY.value = -(screenY * xyProportion);
...
.svgCover {
    ...
    img {
        ...
        margin: 0 auto;
        display: none;
        @media screen and (max-width: $lgMinW) {
            display: block;
        }
    }
}
...
.dark {
    .jumbotron {
        .screen-svg {
            --screen-c-0: #070708 !important;
            --screen-c-2: #13171e !important;
            --screen-c-3: rgb(101, 106, 128) !important;
            --screen-c-5: rgb(190, 201, 239) !important;
            --screen-c-6: rgb(101, 106, 128) !important;
        }

        .people-svg {
            --people-c-0: #2e2929 !important;
            --people-c-1: #3a3838 !important;
            --people-c-9: #1e1f1f !important;
        }

        .left-bottom-layer {
            --lbl-c-0: #1e2835 !important;
            --lbl-c-3: rgb(190, 201, 239) !important;
        }
    }
}
</style>